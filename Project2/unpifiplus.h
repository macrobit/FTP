...
/* new defined structure which records information
   for each socket */
struct sock_info {
  int   sockfd;     /* sockfd */
  struct sockaddr  *sock_addr;  /* IP address bound to the socket */
  struct sockaddr  *sock_ntmaddr; /* netmask for the IP address */
  struct sockaddr  *sock_subnaddr; /* subnet address */
};
